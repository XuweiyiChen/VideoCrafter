...
def get_parser():
    ...
    parser.add_argument("--savedir", type=str, default="/home/tianxia/VideoCrafter/Test/Test_freeinit_f", help="results saving path")
    ...
    parser.add_argument("--unconditional_guidance_scale", type=float, default=0, help="prompt classifier-free guidance")
