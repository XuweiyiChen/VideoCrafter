...
def get_parser():
    ...
    parser.add_argument("--ckpt_path", type=str, default='/home/tianxia/VideoCrafter/checkpoints/base_1024_v1/model.ckpt', help="checkpoint path")
    parser.add_argument("--config", type=str, default='/home/tianxia/VideoCrafter/configs/inference_t2v_1024_v1.0.yaml', help="config (yaml) path")
    ...
    parser.add_argument("--savedir", type=str, default="/home/tianxia/VideoCrafter/Test/Test_freeinit_f_1024", help="results saving path")
