...
#SBATCH --job-name="VideoCrafter_freeinit_seed=0_MSR"
...
python scripts/evaluation/infer.py --prompt_file prompts/data_MSR.txt \
                                   ...
                                   --savedir results/VideoCrafter_freeinit_seed=0_MSR